...
/*
* EDITS:
*   - Outermost vertices adjusted to flip gasket vertically
...
void display() {
  ...
  //EDIT: upside-down sierpinski gasket
  static Point vertices[] = {Point(0, 500), Point(250, 0), Point(500, 500)};
...
void init() {
  ...
  // EDIT: Set a bright green background and draw in blue.
  glClearColor(0.25, 1.0, 0.2, 1.0);
